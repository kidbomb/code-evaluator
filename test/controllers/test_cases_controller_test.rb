...
class TestCasesControllerTest < ActionController::TestCase
  ...
  test "should create test_case" do
    assert_difference('TestCase.count') do
      post :create, test_case: { expected_output: @test_case.expected_output, input: @test_case.input, problem_id: @test_case.problem_id }
    end
  ...
  test "should update test_case" do
    patch :update, id: @test_case, test_case: { expected_output: @test_case.expected_output, input: @test_case.input, problem_id: @test_case.problem_id }
    assert_redirected_to test_case_path(assigns(:test_case))
  end
